...
class SkinImageClassifier:
    def __init__(self, nevus_dir, others_dir, val_nevus_dir, val_others_dir):
        ...
        self.preprocessed_image = self.load_preprocessed_image()
    ...
    def load_random_subset(self, folder_path, subset_size=None):
        ...
        if subset_size is not None:
            ...
            # If subset_size is not specified, load all files
...
if __name__ == "__main__":
    classifier = SkinImageClassifier(nevus_dir='C:/Users/Administrador/Documents/0. MAIA/3. Spain/1.CAD/1.Project_SEP/Skinbinary_train/nevus/', others_dir='C:/Users/Administrador/Documents/0. MAIA/3. Spain/1.CAD/1.Project_SEP/Skinbinary_train/others/',val_nevus_dir='C:/Users/Administrador/Documents/0. MAIA/3. Spain/1.CAD/1.Project_SEP/Skinbinary_val/nevus/', val_others_dir='C:/Users/Administrador/Documents/0. MAIA/3. Spain/1.CAD/1.Project_SEP/Skinbinary_val/others/')
    subset_size = None
